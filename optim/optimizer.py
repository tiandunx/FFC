#####################################################
# borrowed from  pytorch optimizer
# modified time 03.13.2020
#####################################################
import math, torch
...
def get_optim_scheduler(parameters, config):
    assert 'optim' in config and 'scheduler' in config, \
    ...
    if config['scheduler'] == 'cos':
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optim, patience=config['patience'], min_lr=config['LR_min'])
    else:
